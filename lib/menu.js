...
Criador do Bot : Devsaex
Github : https://github.com/blckbr/Devsaexbot
...
@@ -14,6 +14,8 @@ const msgs_texto = {
        ...
        cmd_erro: "[❗] Ops, parece que você digitou o comando *{p1}* incorretamente. Quer aprender a usar?\n\n Digite :\n  - Ex: *{p2} guia* para ver o guia.",
        ...
        "Motivo : {p2}\n"+
        "Quem baniu : {p3}"
@@ -710,7 +712,7 @@ const msgs_texto = {
            sucesso: "🤖✅ Entendido, o BOT será desligado"
        },
        bctodos:{
            anuncio: "[🤖 DevsaexBOT® - Mensagem para todos]\n\n"+
...
@@ -812,14 +814,14 @@ const msgs_texto = {
            reset_sucesso: "🤖✅ As configurações dos grupos foram resetadas com sucesso"
        },
        bcgrupos:{
            anuncio: "[🤖DevsaexBOT® - Mensagem para os grupos]\n\n"+
        ...
        bccontatos:{
            anuncio: "[🤖DevsaexBOT® - Mensagem para os contatos]\n\n"+
